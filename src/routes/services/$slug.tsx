      ...
      <section className="relative overflow-hidden gradient-hero py-12 lg:py-16">
        ...
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-7">
            <Link to="/services" className="text-xs font-bold uppercase tracking-[0.22em] text-brand-blue hover:underline">
              All Services
            </Link>
            <h1 className="mt-3 font-display text-4xl sm:text-5xl lg:text-6xl font-black text-balance">{service.title}</h1>
            <p className="mt-5 text-base sm:text-lg text-muted-foreground max-w-xl">{service.desc}</p>
          </div>
          <div className="lg:col-span-5 relative flex justify-center">
            ...
            <div className={`absolute -top-2 -left-2 h-12 w-12 rounded-full ${c.bg} grid place-items-center ring-4 ring-white shadow-md`}>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-[2rem] gradient-cta text-white p-8 sm:p-10 grid lg:grid-cols-12 gap-6 items-center overflow-hidden relative">
            ...
            <div className="relative lg:col-span-6 text-center lg:text-left">
              ...
              <p className="mt-2 text-white/85 text-sm">Book your home visit in under a minute — we'll be there.</p>
            </div>
            <div className="relative lg:col-span-3 flex flex-wrap gap-3 justify-center lg:justify-end">
              <a href="https://wa.me/919985356507?text=Hi,%20we%20need%20the%20services" className="inline-flex items-center gap-2 rounded-full bg-white/15 backdrop-blur ring-1 ring-white/30 px-5 py-3 font-semibold hover:bg-white/25 transition">
                <WhatsAppIcon className="h-4 w-4" /> WhatsApp
              </a>
              <Link to="/contact" className="inline-flex items-center gap-2 rounded-full bg-white text-foreground px-5 py-3 font-semibold hover:scale-105 transition">
