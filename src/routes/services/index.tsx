  ...
  head: () => ({
    meta: [
      ...
      },
      {
        name: "keywords",
        content:
          "pet services, vaccinations, emergency vet, home IV, deworming, blood work, Hyderabad",
      },
...
function ServicesPage() {
  ...
  const selectedService = service ? SERVICES.find((s) => s.slug === service) : undefined;
  ...
  return (
    <SiteLayout>
      <section className="relative overflow-hidden gradient-hero py-12 lg:py-16">
        ...
        <Amoeba
          variant={3}
          color="oklch(0.72 0.17 55 / 0.15)"
          className="absolute -bottom-20 -right-20 h-96 w-96"
        />
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid lg:grid-cols-12 gap-10 items-center">
          <div className="lg:col-span-7">
            ...
            <h1 className="mt-3 font-display text-4xl sm:text-5xl lg:text-6xl font-black text-balance">
              ...
              <span className="italic text-brand-blue">delivered home</span>
            </h1>
            <p className="mt-5 text-base sm:text-lg text-muted-foreground max-w-xl text-balance">
              Ten core services covering every stage of your pet's health, from routine wellness to
          ...
          <div className="lg:col-span-5 relative flex justify-center">
            <div className="absolute inset-0 grid place-items-center">
              <Amoeba
                ...
                className="h-72 w-72 animate-float"
              />
            </div>
            {/* Video in hero */}
            <div className="relative z-10 w-full max-w-[340px] sm:max-w-[400px] rounded-[1.5rem] overflow-hidden shadow-pop border border-white/40">
              ...
              <div className="absolute bottom-0 left-0 right-0 px-4 py-3 bg-gradient-to-t from-black/55 to-transparent flex items-center gap-2">
                ...
                <span className="text-white text-[10px] font-bold uppercase tracking-[0.16em]">
                  See us in action
                </span>
              </div>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          {selectedService && (
            <div className="mb-8 flex flex-col sm:flex-row sm:items-center justify-between bg-brand-blue-soft border border-brand-blue/20 rounded-3xl p-4 sm:px-6 text-brand-blue font-semibold text-sm animate-fade-in shadow-sm gap-3">
              <span className="flex items-center gap-2">
                ...
                <span>
                  Showing only <strong>{selectedService.title}</strong> at-home service.
                </span>
              </span>
              <Link
                to="/services"
          ...
          >
            {displayedServices.map((s) => {
              ...
              return (
                <article
                  key={s.slug}
                  className={`group relative rounded-3xl bg-card p-7 sm:p-8 flex flex-col items-center text-center border border-border shadow-soft hover:shadow-pop hover:-translate-y-1 transition-all duration-300 ${displayedServices.length === 1 ? "w-full max-w-sm" : ""}`}
                >
                  ...
                  <div className="mb-5 flex justify-center">
                    <div className="relative">
                      ...
                      <div
                        className={`absolute top-0 left-0 h-12 w-12 rounded-full ${c.bg} grid place-items-center ring-4 ring-white shadow-md`}
                      >
                  ...
                  {/* Title & Description */}
                  <h3 className="font-display text-xl font-black text-foreground mt-0">
                    {s.title}
                  </h3>
                  <p className="mt-2.5 text-sm text-muted-foreground leading-relaxed max-w-[260px]">
                    {s.desc}
                  </p>
                  ...
                  >
                    <span
                      className={`flex w-full items-center justify-center gap-2 rounded-full border border-current py-3 text-sm font-semibold transition-all duration-300 ${c.text} hover:bg-current/5`}
                    >
          ...
          <div className="mt-8 rounded-[2rem] gradient-cta text-white p-8 sm:p-10 grid lg:grid-cols-12 gap-6 items-center overflow-hidden relative">
            ...
            <Amoeba
              ...
              className="absolute -bottom-16 -left-16 h-64 w-64"
            />
            <div className="relative lg:col-span-8 text-center lg:text-left">
              ...
              <p className="mt-2 text-white/85 text-sm">
                Tell us about your pet — we'll recommend the right care.
              </p>
            </div>
